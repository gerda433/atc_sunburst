...
ema_medicines <- ema_medicines_names %>%
  ...
  mutate(drug_information = paste0("<b>", name_of_medicine, "</b> - centralised<Br>", "<b>Date authorised</b><Br>", marketing_authorisation_date, "<Br><Br><b>Indication(s)</b><Br>", str_replace_all(therapeutic_area, ";", "<Br>")))
```
...
...Det bliver vist lidt søgt med de danske data
